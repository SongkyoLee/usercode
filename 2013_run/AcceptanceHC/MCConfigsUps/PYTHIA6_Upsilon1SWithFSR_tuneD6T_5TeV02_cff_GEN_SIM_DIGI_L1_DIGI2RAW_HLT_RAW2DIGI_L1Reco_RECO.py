...
# with command line options: Configuration/GenProduction/PYTHIA6_Upsilon1SWithFSR_tuneD6T_5TeV02_cff --conditions STARTHI53_V17::All -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:PIon,RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --eventcontent FEVTSIM --beamspot Realistic8TeVCollisionPPbBoost -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/PYTHIA6_Upsilon1SWithFSR_tuneD6T_5TeV02_cff nevts:1000'),
...
process.FEVTSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Upsilon1SWithFSR_tuneD6T_5TeV02_cff_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_RECO.root'),
