...
void fitUpsilonYields(){
	...
	if (PbPb) {
		finput = "/tmp/kyolee/dimuonTree_upsiMiniTree_pA5tev_14nb_Run210498-210909_trigBit1_allTriggers0_pt4.root";
		figName_ = "masspeak_Hi"; //output fig names
	}
	else {
		finput = "/tmp/kyolee/dimuonTree_upsiMiniTree_7tev_Runa_trigBit1_allTriggers0_pt4.root";
