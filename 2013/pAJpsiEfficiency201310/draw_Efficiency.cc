...
void draw_Efficiency(int fileCode=0)
{
...
*/
	...
	tex->DrawLatex(0.49, 0.30, "centrality 0-100 %");
	c2->SaveAs(Form("h1D_%s_Eff_pt_bin2_FW_m24_p147_pt_65300.pdf",mctype.c_str()));
	c2->Clear();
	//textBR->Clear();
	...
	tex->DrawLatex(0.49, 0.30, "centrality 0-100 %");
	c2->SaveAs(Form("h1D_%s_Eff_pt_bin2_BW_m24_p147_pt_65300.pdf",mctype.c_str()));
	c2->Clear();
	//textBR->Clear();
