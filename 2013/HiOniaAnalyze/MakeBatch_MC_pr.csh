...
pyname=hioniaanalyzer_MC_pr_cfg
outputdir=/afs/cern.ch/user/k/kyolee/private/cms538HI/src/HiAnalysis/HiOnia/test/outTTree_MC_pr ### output directory, don't end with "/"

inname=root://eoscms//eos/cms/store/group/phys_heavyions/dileptons/MC2013/5TeV/Jpsi/Skims/onia2MuMuPAT_MC_

outname=hioniaanalyzer_MC_pr_ ## end with _
workpy=hioniaanalyzer_MC_pr_cfg_bth_ ## end with _
job=job_hioniaanalyzer_MC_pr_bth_ ## end with _
...
#	awk -v p1=$inname$i.root -v p2=$outname$i.root -v p3=True '{gsub("_input_",p1); gsub("_output_",p2); gsub("_prnp_",p3); print;}' $pyname.py > $workpy$i.py;
