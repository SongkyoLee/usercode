...
void draw_trackAccep_manyRuns_noCut()
{
	//Set style
...
*/
	tree->Draw("trkPt:trkEta>>h1","nTrk>0","colz");
	c1->SaveAs("TH2D_trkPt_vs_trkEta_manyRuns_woCut.pdf");
	c1->Clear();	
/*
	tree->Draw("trkPhi:trkEta>>h2",
		...
		"colz");
*/
	tree->Draw("trkPhi:trkEta>>h2","nTrk>0","colz");
	c1->SaveAs("TH2D_trkPhi_vs_trkEta_manyRuns_woCut.pdf");
