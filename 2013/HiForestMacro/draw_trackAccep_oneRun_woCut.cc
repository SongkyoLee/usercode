...
void draw_trackAccep_oneRun_woCut()
{
  //Set style
...
/*
	tree->Draw(
		...
		"colz");
*/
	tree->Draw( "trkPt:trkEta>>trkPt_trkEta_01","nTrk>0","colz");
  c1->SaveAs("TH2D_trkPt_vs_trkEta_MC_woCut.pdf");
  c1->Clear();
/*
	...
	"colz");
*/
	tree->Draw("trkPhi:trkEta>>trkPhi_trkEta_01","nTrk>0","colz");
  c1->SaveAs("TH2D_trkPhi_vs_trkEta_MC_woCut.pdf");
