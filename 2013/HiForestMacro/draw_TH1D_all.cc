...
void draw_TH1D_all()
{
  ...
  //Set style
  gROOT->Macro("/afs/cern.ch/user/k/kyolee/private/cms538HI_test/src/afs/JpsiStyle.C"); 
 ...
 //for eos files, = TFile::Open(root://eoscms//eos/cms/[filename])
  ...
  TH1D *h2 = new TH1D("h2", "", 100, -2.8, 2.8);
  ...
  TH1D *h3 = new TH1D("h3", "", 100, -3.4, 3.4);
  ...
  TH1D *h4 = new TH1D("h4", "", 100, -1.5, 1.5);
  ...
  TH1D *h9 = new TH1D("h9", "", 6, 0., 6.);
  tree -> Project("h9", "Glb_pixLayerWMeas","");
  h9 -> GetXaxis() -> SetTitle("");
  ...
  TH1D *h12 = new TH1D("h12", "", 100, 0., 1.);
  tree -> Project("h12", "Di_vProb","");
  h12 -> GetXaxis() -> SetTitle("");
  ...
  TH1D *h13 = new TH1D("h13", "", 100, 0., 20.);
  tree -> Project("h13", "Sta_pt","");
  h13 -> GetXaxis() -> SetTitle("");
  ...
  TH1D *h14 = new TH1D("h14", "", 100, -2.8, 2.8);
  ...
  TH1D *h15 = new TH1D("h15", "", 100, -3.4, 3.4);
  tree -> Project("h15", "Sta_phi","");
  h15 -> GetXaxis() -> SetTitle("");
  ...
  TH1D *h16 = new TH1D("h16", "", 100, -0.1, 0.1);
  ...
  TH1D *h17 = new TH1D("h17", "", 100, -30.0, 30.0);
  tree -> Project("h17", "Sta_dz","");
  h17 -> GetXaxis() -> SetTitle("");
