...
# Non-prompt MC
#mc1=/afs/cern.ch/work/k/kyolee/private/cms442/src/pAJpsi/outRoo_NPMC_Pbp_sglMuEtaAll/outRoo_NPMC_Pbp_sglMuEtaAll.root
mc1=$(pwd)/outRoo_NPMC_Pbp_sglMuEtaAll/outRoo_NPMC_Pbp_sglMuEtaAll.root
# Prompt MC
#mc2=/afs/cern.ch/work/k/kyolee/private/cms442/src/pAJpsi/outRoo_PRMC_Pbp_sglMuEtaAll/outRoo_PRMC_Pbp_sglMuEtaAll.root
mc2=$(pwd)/outRoo_PRMC_Pbp_sglMuEtaAll/outRoo_PRMC_Pbp_sglMuEtaAll.root
...
rapbins=(-2.4--1.47 -1.47--0.47 -0.47-0.53 0.53-1.47 -2.4--0.47 -0.47-1.47 -1.47-0.53)
rapfiner=(-2.4--1.97 -1.97--1.47 -1.47--0.97 -0.97--0.47 -0.47-0.03 0.03-0.53 0.53-1.03 1.03-1.47)
rapfiner2=(-2.4--1.97 -1.97--1.72 -1.72--1.47 -1.47--1.22 -1.22--0.97 -0.97--0.72 -0.72--0.47 -0.47--0.22 -0.22-0.03 0.03-0.28 0.28-0.53 0.53-0.78 0.78-1.03 1.03-1.47)
rapcoarser=(-2.4--0.47 -0.47-1.47)
rapside=(-2.4--1.97 1.03-1.47)
...
for rap in ${rapcoarser[@]}; do
#  for pt in ${pthigher[@]}; do # for sglMuEtaHigher
  for pt in ${ptcoarser2[@]}; do # for sglMuEtaFiner2 - original analysis
    program $rap $pt 0.0-100.0
  done
#  for pt in ${ptlower[@]}; do #for slgMuEtaLower
#    program $rap $pt 0.0-100.0
