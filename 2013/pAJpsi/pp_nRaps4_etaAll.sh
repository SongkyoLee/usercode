...
# Non-prompt MC
mc1=/afs/cern.ch/user/k/kyolee/private/cms442/src/pAJpsi/outRooData_MC/pp/nonPrompt_singleMuEtaAll_bit1/Data2013_cent0-100_dPhi0.000-1.571.root
#mc1=/afs/cern.ch/user/k/kyolee/private/cms442/src/pAJpsi/outRooData_MC/Pbp/nonPrompt_singleMuEtaAll_bit1/Data2013_cent0-100_dPhi0.000-1.571.root
# Prompt MC
mc2=/afs/cern.ch/user/k/kyolee/private/cms442/src/pAJpsi/outRooData_MC/pp/prompt_singleMuEtaAll_bit1/Data2013_cent0-100_dPhi0.000-1.571.root
#mc2=/afs/cern.ch/user/k/kyolee/private/cms442/src/pAJpsi/outRooData_MC/Pbp/prompt_singleMuEtaAll_bit1/Data2013_cent0-100_dPhi0.000-1.571.root

# Choose ctau error file
ctauErrFile=/afs/cern.ch/user/k/kyolee/private/cms442/src/pAJpsi/outCTauErr_pp/ctauErrRange_singleMuEtaAll_bit1.txt;
#ctauErrFile=/afs/cern.ch/user/k/kyolee/private/cms442/src/pAJpsi/outCTauErr_Pbp/ctauErrRange_singleMuEtaAll_bit1.txt;
...
rapbins=(-1.93--1.00 -1.00-0.00 0.00-1.00 1.00-1.93 -1.93-0.00 0.00-1.93 -1.00-1.00 -1.93-1.93)
#rapbins=(-2.4--0.47 -2.4--1.47 -1.47--0.47 -0.47-1.47 -0.47-0.53 0.53-1.47 -1.47-0.53)
...
#      printf "source /afs/cern.ch/sw/lcg/external/gcc/4.3.2/x86_64-slc5/setup.csh; source /afs/cern.ch/user/m/miheejo/thisroot.csh\n" >> $work.csh
      ...
      printf "cd -\n" >> $scripts/$work.csh
      printf "cp %s/%s %s/fit2DData.h %s/fit2DData_pp.cpp .\n" $scripts $work.csh $(pwd) $(pwd) >> $scripts/$work.csh
...
#          echo $script >> $scripts/$work.csh
      ...
      printf "tar zcvf %s.tgz %s* fit2DData.h fit2DData_pp.cpp\n" $work $work >> $scripts/$work.csh
...
for rap in ${rapbins[@]}; do
  program $rap 6.5-30.0 0-100 # inclusive
...
#    "-1.47--0.53"|"0.47-1.47"|"-0.53-1.47"|"-1.47--0.47"|"0.53-1.47"|"-1.47-0.53")
    "-1.93--1.00"|"-1.00-0.00"|"0.00-1.00"|"1.00-1.93"|"-1.00-1.00")
    for pt in ${ptcorser[@]}; do
#      program $rap $pt 0-100
      program $rap $pt ${centcorser[@]}
    done
...
#    program $rap 6.5-30.0 ${centfiner[@]}
  ...
  # cent dependence
#  program $rap 6.5-30.0 ${centcorser[@]} #not for pp
